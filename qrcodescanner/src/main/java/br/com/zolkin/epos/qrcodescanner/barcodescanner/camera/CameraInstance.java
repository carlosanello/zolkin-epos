...
import br.com.zolkin.epos.qrcodescanner.barcodescanner.Util;
...
public class CameraInstance {
        ...
        public void run() {
            try {
                ...
                if (readyHandler != null) {
                    readyHandler.obtainMessage(R.id.zolkin_prewiew_size_ready, getPreviewSize()).sendToTarget();
                }
            } catch (Exception e) {
                notifyError(e);
    ...
    private void notifyError(Exception error) {
        if (readyHandler != null) {
            readyHandler.obtainMessage(R.id.zolkin_camera_error, error).sendToTarget();
        }
    }
}
